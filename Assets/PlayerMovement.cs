...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Awake()
    {
        //These help to grab references for rigidbody and animator from object
    ...
    private void Update()
    {
        ...
        //This makes it so that when the character moves left or right they spin the sprite in that direction
